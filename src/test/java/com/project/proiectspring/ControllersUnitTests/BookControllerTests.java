package com.project.proiectspring.ControllersUnitTests;
...
class BookControllerTest {
    ...
    void testGet() {
        ...
        when(bookService.get(author.getId())).thenReturn(Collections.singletonList(new Book()));

        List<Book> result = bookController.get(author.getId());
